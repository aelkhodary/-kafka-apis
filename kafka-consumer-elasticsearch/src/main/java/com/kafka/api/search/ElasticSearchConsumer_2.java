...
public class ElasticSearchConsumer_2 {
    ...
    public static KafkaConsumer<String, String> createConsumer(String topic) {
        ...
        props.setProperty(ConsumerConfig.GROUP_ID_CONFIG, "kafka-demo6-elasticsearch");
    ...
    public static void main(String[] args) {
        Logger logger = LoggerFactory.getLogger(ElasticSearchConsumer_2.class.getName());
